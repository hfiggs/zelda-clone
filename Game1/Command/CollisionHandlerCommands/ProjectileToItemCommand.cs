...
namespace Game1.Command.CollisionHandlerCommands
{
    class ProjectileToItemCommand : ICollisionCommand
    {
        ...
        public void Execute(Collision collision)
        {
            ...
            if (!projectile.GetType().Equals(typeof(SwordBeam)) && !projectile.GetType().Equals(typeof(EnemyBoomerang)) && !projectile.GetType().Equals(typeof(Fireballs)) && !projectile.GetType().Equals(typeof(SingleFireball)) && !(projectile is PortalProjectile)) {
