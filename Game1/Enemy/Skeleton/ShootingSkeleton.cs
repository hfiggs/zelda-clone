...
namespace Game1.Enemy
{
    class ShootingSkeleton : IEnemy
    {
        ...
        public ShootingSkeleton(Game1 game, Vector2 spawnPosition)
        {
            this.game = game;
            positon = spawnPosition;
            state = new EnemyStateSpawning(positon, this, new ShootingSkeletonStateMoving(spawnPosition, this, game.Screen));
            health = twoHearts;
        }
