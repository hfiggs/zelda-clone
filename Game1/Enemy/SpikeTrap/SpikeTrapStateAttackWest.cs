...
{
    class SpikeTrapStateAttackWest : IEnemyState
    {
        ...
        public SpikeTrapStateAttackWest(Game1 game, IEnemy spiketrap, Vector2 homePosition, int verticalRange, int horizontalRange)
        {
        ...
        public List<Rectangle> GetHitboxes()
        {
            ...
            hitboxList.Add(new Rectangle((int)currentPosition.X, (int)currentPosition.Y, widthAndHeight, widthAndHeight));
            return hitboxList;
        }
